...
namespace Assets._01.Member.CDH.Code.Cores
{
    public class TransitionManager : MonoSingleton<TransitionManager>
    {
        ...
        [SerializeField] private SoundID transitionStartSoundID, transitionEndSoundID;
        ...
        {
            soundChannel.Invoke(SoundEvents.PlayEvent.Initialize(transitionStartSoundID, transform));
            ...
            soundChannel.Invoke(SoundEvents.StopEvent.Initialize(transitionStartSoundID));
        }
        ...
        {
            soundChannel.Invoke(SoundEvents.PlayEvent.Initialize(transitionEndSoundID, transform));
            transitionAnimator.speed = 1f;
            ...
            soundChannel.Invoke(SoundEvents.StopEvent.Initialize(transitionEndSoundID));
        }
    }
}
